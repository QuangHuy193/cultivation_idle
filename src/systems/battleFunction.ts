...
import { Log } from "@/lib/types/battleTypes";

// export const playerTurn = (battle:any, character:any, currentMonster:any, updateBattle:any) => {
...
//         (s:any) => s.skillId._id === battleSkill.skillId,
//       );
